...
import swing.table.scroll.ScrollBarCustomUI;

/**
 *
 * @author sethk TableCustom.apply(jScrollPane1,
 * TableCustom.TableType.MULTI_LINE); getContentPane().setBackground(new
 * Color(250, 250, 250));
 */
